...
- Better animations between Photos, Albums and Settings sections. 
- Fixed dialogs and menus that were rendering with default light theme colors instead of the app's dark theme.
